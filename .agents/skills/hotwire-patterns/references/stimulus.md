...
Stimulus é uma estrutura JavaScript modesta para adicionar comportamento ao HTML. Ele conecta objetos JavaScript (controllers) a elementos DOM usando atributos de dados.

## Conceitos Básicos

| Conceito | Purpose | Attribute |
|---------|---------|-----------|
