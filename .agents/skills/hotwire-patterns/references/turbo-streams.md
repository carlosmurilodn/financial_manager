# Referência Turbo Streams

## Conceito

Turbo Streams entrega alterações de página como um conjunto de ações a serem executadas em elementos DOM específicos. Eles podem anexar, preceder, substituir, atualizar, remover, antes ou depois.
...
### Transmissão do Controller/Trabalho
