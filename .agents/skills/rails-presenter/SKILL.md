...
description: >-
  Cria presenter objects para formatação de views usando o padrão SimpleDelegator com
  TDD. Use ao extrair lógica de view de models, formatar dados para exibição, criar
  badges/rótulos ou quando o usuário mencionar presenters, view models, formatação
  ou helpers de exibição.
license: MIT
...
Cria presenters que encapsulam formatação específica de view com specs primeiro.
...
### Etapa 1: Crie a spec do presenter (RED)
...
### Etapa 2: Run Spec (Confirm RED)

```bash
bundle exec rspec spec/presenters/[resource]_presenter_spec.rb
```

### Etapa 3: Implement Presenter (GREEN)
...
### Etapa 4: Run Spec (Confirm GREEN)
