...
name: tdd-cycle
description: >-
  Guia o fluxo de desenvolvimento orientado a testes com o ciclo Red-Green-Refactor.
  Use quando o usuário quiser implementar uma feature com TDD, escrever testes
  primeiro, seguir práticas de desenvolvimento orientado a testes ou mencionar
  red-green-refactor.
license: MIT
...
This skill guides you through the Test-Driven Desenvolvimento cycle:
...
## Etapa 3: Write Failing Spec (RED)
